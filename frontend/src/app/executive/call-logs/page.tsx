...
export default function CallLogsPage() {
  ...
  return (
    <div className="space-y-6 animate-fadeIn text-slate-800">
      <div>
        <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900">Call Logs</h1>
        <p className="text-slate-500 text-xs sm:text-sm mt-1">Review histories of telephonic interactions and client notes.</p>
      </div>
